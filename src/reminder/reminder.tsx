    ...
    <>
        <div className="reminder-container" >
            <div className="reminder-header">
                <p className="firstChild" >Improve and measure your skills with study reminder</p>
                <p className="secondChild" >Set reminder in your application and save time automation tracking.</p>
            </div>
            <div className="reminder-image-container">
                <img className="reminder-image" src={woman}  alt="woman-calendar"/>
            </div>
            <div className="btn" >
                <Link to="/calender" className='btn-link'>Set Reminder</Link>
            </div>
